      ...
      >
        ...
        {showUserLocation && (
          <GeolocateControl
            ...
            // radio active the whole time the map is mounted, which is a major
            // contributor to device heat (especially while a sighting is being
            // uploaded with the map sitting behind the sheet). Take a single
            // fix and stop.
